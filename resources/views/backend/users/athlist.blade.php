...
<input type ="hidden" name="type" id="type" value= "athlete">
    ...
    <section class="content userdata">
        <div class="row">
         <div class="col-12">
          @if(Auth::user()->role==2)
           <div class="adduser">
              <button type="button"data-toggle="modal" data-target="#myModal">Add Athlete</button>
            </div>
          @endif
            <div class="col-12">
                <!-- /.card -->
                                ...
                                @foreach(@$allathletes as $key=>$value)
                                    <tr>
                                       ...
                                       <td class="fit" style="text-align:center;">
                                            ...
                                            <a href="javascript:void(0)" class="nutrition" data-userid="{{$value->id}}">
                                            <i class="fa fa-cutlery" aria-hidden="true" title="nutrition details" style="position: relative; margin-left:7px;color:#3c8dbc !important"></i>
                                            </a>
                                            <a href="{{url('workout_add').'/'.base64_encode($value->id).'/personalworkout'}}" data-id="" class="personal_workout">
                                              <i title="add personal workout" class="fa fa-plus" aria-hidden="true" style="position: relative; margin-left:7px;color:#3c8dbc !important"></i>
                                            </a>
                                            @if($role==0)
                                              <a href= "{{url('/chatathlete/'.base64_encode($value->id).'/'.base64_encode($value->coach_id))}}">
                                               <i  title="chat" class="fas fa-comment" style="position: relative; margin-left:7px;color:#3c8dbc !important">
                                              </i></a>
                                            @endif
                                        </td> 
                                    </tr>
